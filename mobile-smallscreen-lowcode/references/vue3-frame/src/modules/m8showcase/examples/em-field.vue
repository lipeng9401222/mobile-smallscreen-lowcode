    ...
    <div class="container">
        <div class="van-content">
            ...
            <em-cell-group>
                ...
                <!-- 允许输入正整数，调起纯数字键盘 -->
                <em-field v-model="digit" type="number" label="整数" placeholder="请输入整数" />
                <!-- 允许输入数字，调起带符号的纯数字键盘 -->
                <em-field v-model="number" type="digit" label="数字" placeholder="请输入数字" />
                <!-- 输入密码 -->
            ...
            <em-cell-group>
                <em-field label="文本" modelValue="输入框只读" readonly />
                <em-field label="文本" modelValue="输入框已禁用" disabled />
            </em-cell-group>
            ...
            <h4 class="cell-title">格式化输入内容（过滤数字）</h4>
            <em-cell-group>
