(function () {
    ...
    const getTiming = () => {
        ...
        Console.log(`网络请求耗时: ${timing.responseEnd - timing.responseStart}ms`);
        Console.log(`白屏时间: ${timing.responseEnd - timing.fetchStart}ms`);
        Console.log(`首次可交互时间: ${timing.domInteractive - timing.fetchStart}ms`);
