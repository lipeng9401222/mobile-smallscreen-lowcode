    ...
    <div class="container register" id="container" ref="container">
        <div class="content" ref="content">
            ...
            <em-form :show-error="false" @submit="onSubmit">
                ...
                <footer>
                    <!-- 隐私授权协议组件 -->
                    <privacyFooter :isRead.sync="isRead" ref="emFooter"></privacyFooter>
                    <em-button
...
const eyeClose = require('../../images/icon_eye_close.png');
const eyeOpen = require('../../images/icon_eye_open.png');
